...
import No1.login_app.models.Profile;
import No1.login_app.models.User;
...
public class Main {
    ...
    private static void showLoginMenu() {
        ...
        if (userIndex != -1) {
            ...
            boolean isPasswordMatch = password.equals(listUser.get(userIndex).password);
            /*
             * TODO done
    ...
    private static void showRegisterMenu() {
        ...
        profile = new Profile(fullName, hobby, age);
        /*
         * TODO done
        ...
        profile = new Profile(fullName, hobby, age, StringUtils.nickName(fullName));
        /*
         * TODO done

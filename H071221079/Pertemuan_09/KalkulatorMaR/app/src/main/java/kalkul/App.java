...
public class App extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        stage = primaryStage;
        stage.getIcons().add(new Image("file:D:/kalkul.png"));
    ...
    private void showFirstScene(){
        Label label = new Label("  Kalkulator MaRnevorget  ");
        label.setStyle("-fx-font-family: 'Comic Sans MS'; -fx-font-size: 20px; -fx-background-color: #93aa14; -fx-text-fill: #020201; -fx-background-radius: 60; -fx-border-color: BLACK;-fx-border-radius:60");
        VBox vbox1 =new VBox(50,label);
        vbox1.setAlignment(Pos.TOP_CENTER);
        

        ImageView imageView = new ImageView();
        String foto = "file:D:/kal.png";
        ...
        button.setStyle("-fx-font-weight: bold;-fx-font: 30 arial;-fx-background-color: BLUE;-fx-text-fill: #020201;-fx-background-radius: 100");

        VBox vbox3=new VBox(15, button);
        vbox3.setAlignment(Pos.TOP_CENTER);

        VBox asli = new VBox(45,vbox1,vbox2,vbox3);
        asli.setAlignment(Pos.CENTER);
        // asli.getChildren().addAll(vbox1,vbox2,vbox3);

        Image bekgrong = new Image("wallp.jpg");
        BackgroundImage backgroundImage = new BackgroundImage(bekgrong,BackgroundRepeat.NO_REPEAT, BackgroundRepeat.NO_REPEAT, 
        BackgroundPosition.DEFAULT, BackgroundSize.DEFAULT);
        Background background = new Background(backgroundImage);
        asli.setBackground(background);
        
        Scene scene1 = new Scene(asli,500,500);
        stage.setTitle("KalKuLator MaR");
    ...
    private void KalkulatorPersegi(){
        ...
        luaspersegi.setStyle("-fx-font-family: 'Comic Sans MS'; -fx-font-size: 10px; -fx-font-weight: bold; -fx-background-color: #a38d20; -fx-text-fill: #020201; -fx-background-radius: 100;");
        Button kelilingpersegi = new Button("Hitung Keliling");
        kelilingpersegi.setStyle("-fx-font-family: 'Comic Sans MS'; -fx-font-size: 10px; -fx-font-weight: bold; -fx-background-color: #a38d20; -fx-text-fill: #020201; -fx-background-radius: 100;");
        Button clear= new Button("CLEAR");
        clear.setStyle("-fx-font-family: 'Comic Sans MS'; -fx-font-size: 10px; -fx-font-weight: bold; -fx-background-color: #a38d20; -fx-text-fill: #020201; -fx-background-radius: 100;");
        Button balikmenu = new Button("KEMBALI KE MENU");
        balikmenu.setStyle("-fx-font-family: 'Comic Sans MS'; -fx-font-size: 10px; -fx-font-weight: bold; -fx-background-color: #a38d20; -fx-text-fill: #020201; -fx-background-radius: 100;");
        TextField sisipersegi = new TextField();
        sisipersegi.setPromptText("masukin sisi sini");

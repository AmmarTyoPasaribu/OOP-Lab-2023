...
public class Main {
    public static void main(String[] args) {
        PengurusInti pengurus1 = new PengurusInti("Ammar", "Ketua", "IT");
        KoordinatorBidang koordinator1 = new KoordinatorBidang("Tyo", "Koordinator", "Web Development");
        Staf staf1 = new Staf("Pasaribu", "Staf", "Membantu tugas-tugas pengurus inti");

...
public class Main {
    ...
    private static void showLoginMenu() {
        ...
        if (userIndex != -1) {
            ...
            if (isPasswordMatch) {
                ...
                /*
                 * TODO
                 * panggil method showDetailUser dan kirimkan data Profile User yang login7777777777777777777777777
                 * 
                 */
    ...
    private static void showDetailUser(Profile profile) {
        /*
         * TODO *
         * Tampilkan semua data profile user yang login 88888888888888888888888888888
         */
